          ...
          <div className="mb-5 my-5">
            <div className="rating-area">
              <div className="rating-result">
                <span
                  className={this.props.feedback?.rate > 0 ? "active" : ""}
                ></span>
                <span
                  className={this.props.feedback?.rate > 1 ? "active" : ""}
                ></span>
                <span
                  className={this.props.feedback?.rate > 2 ? "active" : ""}
                ></span>
                <span
                  className={this.props.feedback?.rate > 3 ? "active" : ""}
                ></span>
                <span
                  className={this.props.feedback?.rate > 4 ? "active" : ""}
                ></span>
              </div>
            </div>
          </div>
